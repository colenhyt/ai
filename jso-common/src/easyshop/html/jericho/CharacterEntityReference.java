...
public class CharacterEntityReference extends CharacterReference {
	...
	/**
	 * <samp>&apos;</samp> &amp;apos; = &amp;#39; -- apostrophe = APL quote, U+0027 ISOnum<br />(see <a href="#_apos">comments</a>).<p>
	 * apos is only defined for use in XHTML (see the <a target="_blank" href="http://www.w3.org/TR/xhtml1/dtds.html#a_dtd_Special_characters">XHTML Special Characters Entity Set</a>), but not in HTML.
	 * @see CharacterReference#ApostropheEncoded
	 */
	public static final char _apos='\'';

	private static Map NAME_TO_CODE_POINT_MAP=new HashMap(337,1.0F); // 253 entities in total
	 ...
	 * This library will recognise certain invalid forms of character references, as detailed in the {@link #decode(CharSequence) decode(String encodedString)} method.
	 * <p>
	...
	protected static final StringBuffer appendCharacterReferenceString(StringBuffer sb, String name) {
	...
	static CharacterReference construct(Source source, int begin) {
		...
		int maxSourcePos=source.length()-1;
		int end;
		int x=nameBegin;
