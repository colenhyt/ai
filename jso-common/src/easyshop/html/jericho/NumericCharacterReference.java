...
public class NumericCharacterReference extends CharacterReference {
	 ...
	 * <p>
	 * To encode text using hexadecimal numeric character references only, use the {@link #encodeHexadecimal(CharSequence)} method instead.
	 *
	 ...
	 * {@link CharacterReference#encode(CharSequence)} method instead.
	 * <p>
	 * To encode text using decimal numeric character references only, use the {@link #encodeDecimal(CharSequence)} method instead.
	 *
	 * @param unencodedText  the text to encode.
	 * @return the encoded string.
	 * @see #decode(CharSequence encodedText)
	 ...
	 * This library will recognise certain invalid forms of character references, as detailed in the {@link #decode(CharSequence) decode(CharSequence encodedText)} method.
	 * <p>
