...
public final class Element extends Segment {
	...
	public String getContentText() {
		return isEmpty() ? null : source.subSequence(startTag.end,getContentEnd()).toString();
	}
	 ...
	 * <p>
	 * Note that before version 1.5 this method returned <code>null</code> if the element was {@linkplain #isEmpty() empty},
	...
	public Segment getContent() {
		return new Segment(source,startTag.end,getContentEnd());
	}
	 ...
	 * <p>
	 * The representation of an empty element is either a start tag immediately followed by an end tag,
	 * or an {@linkplain StartTag#isEmptyElementTag() empty-element tag}.
	 *
	 ...
	 * @return the {@link FormControl} defined by this element, or <code>null</code> if it is not a <a target="_blank" href="http://www.w3.org/TR/html4/interact/forms.html#h-17.2">control</a>.
	 */
	...
	public String getDebugInfo() {
		return "Element "+super.getDebugInfo()+": "+startTag.getDebugInfo()+"-"+(endTag==null ? "(no end tag)" : endTag.getDebugInfo());
	}
