...
final class SpecialTag {
	...
	public static final SpecialTag COMMENT=new SpecialTag("comment",Tag.COMMENT,"<!--","-->",false,false); // note that according to the spec, whitespace may be present between the "--" and ">" of the end delimiter, but ignoring this will probably yield results consistent with most browsers
	...
	static {
		map=new HashMap(12,1.0F); // 9 special tags in total
